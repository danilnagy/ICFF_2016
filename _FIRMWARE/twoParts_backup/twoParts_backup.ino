...
//  Serial.println(values);
  ...
  analogWrite16(9, val(int(lights[15] -> getValueNorm())));
  analogWrite16(10, val(int(lights[16] -> getValueNorm())));

//  pwm.setPWM(0, 0, val(int(lights[0] -> getValueNorm())) );
